...
var CreatePageComponent = /** @class */ (function () {
    function CreatePageComponent(postService, alert) {
    ...
    CreatePageComponent.prototype.submit = function () {
        ...
        this.postService.create(post).subscribe(function () {
            _this.form.reset();
...
var DashboardPageComponent = /** @class */ (function () {
    ...
    DashboardPageComponent.prototype.remove = function (id) {
        ...
        this.dSub = this.postService.remove(id).subscribe(function () {
            _this.posts.filter(function (post) { return post.id !== id; });
...
var EditPageComponent = /** @class */ (function () {
    ...
    EditPageComponent.prototype.submit = function () {
        ...
        this.submitted = true;
        this.uSub = this.postsService.update(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.post), { text: this.form.value.text, title: this.form.value.title })).subscribe(function () {
            _this.submitted = false;
            _this.alert.success('Пост  был отредактирован');
        });
    };
